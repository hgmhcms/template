$(document).ready(function() {
	...
	<!-- 导流微信链接 -->
	var htmlurl =
		'<div id="layui-m-layer0" class="layui-m-layer layui-m-layer0" index="0"><div class="layui-m-layershade"></div><div class="layui-m-layermain"><div class="layui-m-layersection"><div class="layui-m-layerchild  layui-m-anim-scale"  content="width=device-width"><img style="width:100%" src="https://cdn.jsdelivr.net/gh/hgmhcms/template/wp/2.gif" alt="" /><h3 style="">复制成功</h3><div class="layui-m-layercont">马上微信搜索关注！</div><div class="layui-m-layerbtn"><span no="" type="0" class="zhidaole">朕知道了</span><span yes="" type="1" class="dakaiweixin">打开微信搜索</span></div></div></div></div></div><div class="see-modal"><ul class="see-tip"><h4>完整版漫画阅读方法</h4><li>1、点击复制按钮，进入微信</li><li>2、搜索框粘贴复制的文字</li><li>3、点击搜索下方"访问网页"即可</li></ul><span data-clipboard-action="copy" data-clipboard-text="' +
		copyTxturl +
